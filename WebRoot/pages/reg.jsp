  ...
  <div class="container">
    <div class="register-box">
      ...
      <div class="cell">
        ...
        <span> 密　　码：</span>
        <div class="cell">
          <s:password name="userPassword" id="userPassword" cssClass="text"></s:password>
          </div>
          <span> 确认密码：</span>
          <div class="cell">
          <s:password name="againPassword" id="againPassword" cssClass="text"></s:password>
        </div>
        	<div>
          <s:select list="#session.headFace" name="userFace" cssClass="face" headerKey="user0.gif" headerValue="--请选择头像--"></s:select>
          <s:radio name="userSex" list="%{#{'男':'男','女':'女'}}" value="男" cssClass="sex"></s:radio>
          </div>
        <span> 电子邮件：</span>
        <div class="cell">
          <s:textfield name="userEmail" id="userEmail" cssClass="text"></s:textfield>
        </div>
        <span>来　　自：</span>
        <div class="cell">
          <s:textfield name="userFrom" id="userFrom" cssClass="text"></s:textfield>
        </div>
        <span>备　　注：</span>
        <div class="cell">
          <s:textfield name="userPs" id="userPs" cssClass="text"></s:textfield>
        </div>
